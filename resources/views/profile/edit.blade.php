@extends('layouts.app', ['activePage' => 'pegawai', 'title' => 'Light Bootstrap Dashboard Laravel by Creative Tim & UPDIVISION', 'navName' => 'User Profile', 'activeButton' => ''])
        ...
        <div class="section-image">
            ...
            <div class="row">
                ...
                <div class="card col-md-8 mx-auto">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('profile.update') }}" autocomplete="off" class="dev" enctype="multipart/form-data">
                            @csrf
                            @method('patch')
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-default mt-4" onclick="return confirm('Apakah yakin ingin mengubah profil?')">{{ __('Save') }}</button>
                                </div>
                            </div>
                        </form>
                        <hr class="my-4" />
                        <form method="post" action="{{ route('profile.password') }}" class="dev">
                            @csrf
                            @method('patch')
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-default mt-4" onclick="return confirm('Apakah yakin ingin mengubah password?')">{{ __('Change password') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
