    ...
    <div class="sidebar-wrapper">
        ...
        <ul class="nav">
            <li class="nav-item @if($activePage == 'dashboard') active @endif">
                <a class="nav-link dev" href="{{route('dashboard')}}">
            ...
            <li class="nav-item">
                <a class="nav-link dev" data-toggle="collapse" href="#laravelExamples" @if($activeButton=='laravel' ) aria-expanded="true" @endif>
                    <i>
