                ...
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <div class="table-responsive">
                            ...
                            <form method="POST" enctype="multipart/form-data" action="/editruang/{{$ruangan->id_ruang}}/{{{Auth::user()->id_perusahaan}}}">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="gedung" id="gedung" class="form-control">
                                        ...
                                        @if ($lantai->id_gedung != $ruangan->id_gedung)
                                        <option id="{{$lantai->jml_lantai}}" value="{{$lantai->id_gedung}}">{{ $lantai->gedung }}</option>
                                        @endif
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="kapasitas" id="kapasitas" value="{{$ruangan->kapasitas}}" type="number" min="1" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
