                ...
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <div class="table-responsive">
                            ...
                            <form method="POST" action="/tambahgedungmaster">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($errors->get('perusahaan'))
                                    <div class="alert alert-danger alert-dismissible fade show" style="margin-top: 10px;" role="alert">
                                        <strong>Error!</strong> Harap pilih perusahaan untuk mendaftarkan gedung terlebih dahulu.
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                        ...
                        <a href="/showGedungMaster" class="btn btn-primary btn-round">Kembali</a>
