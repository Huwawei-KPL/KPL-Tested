...
$('.batal-pinjam').click(function() {
    ...
    $("#batalkan-form").attr('action', '/dev/public/batalpinjam/' + id);
    alert($("#batalkan-form").attr('action'));
...
$('#buttonjadwalruang').click(function() {
    var ruang = $('#jadwalruang').val();
    var tanggal = $('#tanggaljadwalruang').val();
    $("#formjadwalruang").attr('action', '/dev/public/jadwalruang/' + ruang + '/' + tanggal);
    document.getElementById('formjadwalruang').submit();
